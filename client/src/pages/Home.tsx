...
// Release scope: Context 02 is the dedicated Automotive After-sales route.
const industryCards = [
  { title: "Kitchens & Interior", detail: "From project enquiry to the next commercial action", number: "01" },
  { title: "Automotive After-sales", detail: "From a recent service enquiry to a clearer callback, appointment or human follow-up.", number: "02", href: "/industries/automotive-after-sales" },
